...
// (그 외에는 무조건 광고 표시)
export const AD_COUNTED = new Set<IAdShowCategory>([
  AD_SHOW_CATEGORY.map,
  AD_SHOW_CATEGORY.story,
]);

export const AD_COUNT_STORAGE_KEY: Partial<Record<IAdShowCategory, string>> = {
...
export const MAX_BY_AD_COUNT: Partial<Record<IAdShowCategory, number>> = {
